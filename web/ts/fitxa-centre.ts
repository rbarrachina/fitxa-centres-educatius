(() => {
  ...
  const init = (): void => {
      ...
      let territorialMap: any = null;
      let territorialLayer: any = null;
      let territorialCentreLayer: any = null;
      let comarcaMap: any = null;
      let comarcaLayer: any = null;
      let comarcaCentreLayer: any = null;
      let municipiMap: any = null;
      let municipiLayer: any = null;
      let municipiCentreLayer: any = null;
      ...
      const openTerritorialMapModal = async (territorialName: string, centreName: string, centreX: string, centreY: string): Promise<void> => {
      ...
      const openComarcaMapModal = async (comarcaName: string, centreName: string, centreX: string, centreY: string): Promise<void> => {
      ...
      const openMunicipiMapModal = async (municipiName: string, centreName: string, centreX: string, centreY: string): Promise<void> => {
